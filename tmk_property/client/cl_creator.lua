...
function Properties:CreateProperty()
    ...
    TriggerServerEvent("ESX:createProperty", Property.Name, Property.Pos, Property.Garage.Pos and Property.Garage.Pos or vector3(math.random(0, 5000), math.random(0, 5000), 1000), Property.Garage.Max, Property.Interior.Name, Property.Price, Property.MaxChest.Max)
