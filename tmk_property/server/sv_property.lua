...
AddEventHandler("ESX:createProperty", function(name, propertypos, garagepos, garagemax, interior, price, maxChest)
    ...
    Wait(500)
    TriggerEvent("cProperty:Actualizes")
end)
...
RegisterNetEvent("cProperty:Actualizes")
AddEventHandler("cProperty:Actualizes", function()
    Wait(5000)
    Server.Actualz = {}
    Server.Properties = {}
    Wait(500)
    ...
    function(result)
        ...
        print("Actualize Clippy Properties")
        Server.Actualz = result
        TriggerClientEvent("cProperty:ActualizeProperties", -1, result)
    end)
end)
